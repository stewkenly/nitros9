...
* Added "WILDBITS" build condition.  If not set, build for the CoCo+GMC Cartridge.
*
*   8      2025/11/18  R Taylor
* Added ability to play raw SID dumps (.sdr) on the Wildbits.
*
*   9      2025/11/29  R Taylor
* Added ability to play Lyra (.lyr) files on the Wildbits.
*
...
********************************************************************
* Musica Player
* Outputs to both SIDs on Wildbits, or Game Master Cartridge on CoCo
...
* For the Wildbits version we split Musica Voices 1-4 between two chips for a stereo effect.
...
* built for a CoCo or the Wildbits
*

********************************************************************
* scnetrxm - SuperCoCo S2A7 64 KiB RX measurement probe
********************************************************************

                    nam       scnetrxm
                    ttl       SuperCoCo S2A7 RX measurement
...
Expected            rmb       BlockSize
RxBuffer            rmb       BlockSize
ReadByte            rmb       1
MemSize             equ       .

                    mod       ModSize,ModName,tylg,atrv,Start,MemSize
ModName             fcs       /scnetrxm/
                    fcb       edition
...
* Consume orderly-close indication only after all 64 KiB reached the guest.
                    lda       PathNum,u
                    leax      ReadByte,u
                    ldy       #1
                    os9       I$Read

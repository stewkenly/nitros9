...
* core yields 197,486 (DW dead). Both machines now pair with BAUDCE-fixed
* cores (v8_rc3, 2026-08-28): disks built from this source require rc3+
* cores on BOTH the K2 and the Jr2.
